...
# E Coli seems to have a normal distribution vs Dissolved Oxygen mg L
# E Coli seems to have a normal distribution vs Dissolved Oxygen (Sat)
# E Coli seems to have a negative Exponent graph vs Electrical Conductivity
# E Coli seems to have a normal distribution of correlations vs pH
...
```{r - Modeling part 2 - Classification}
#Creating pH as a factor
training_data$pHlabel = cut(training_data$pH,2*(0:7),labels = c('Highly Acidic','Acidic','Slightly Acidic','Neutral','Slightly Basic','Basic','Highly Basic'))
